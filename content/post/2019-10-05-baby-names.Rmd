...
Well, it turns out that between 1972 and 1995 the name "Christopher" was the second-most popular name (or 3rd). So, I guess that explains it?

What was the most popular boy name during that time? Michael - it dominated. Michael was the top boy name between for 44 years bewteen 1954 and 1998 (except for 1960). Yet Michael doesn't _seem_ as common among my co-workers. Guess there's just something about Chris. Pretty cool name.

Let's look at the top 10 names for boys across time:
...
Perhaps names are like wardrobes in America. The stereotypical male's warddrobe is probably like a set of 5 blue shirts, maybe one grey, and, in the rare case, a green shirt. (Look around you at work - how many men in business casual aren't wearing some shade of blue?) Throw in a few pairs of pants, and you've got your outfits for the next few months. Women have a more refined approach - outfits for every occasion. The disparity in unique names maybe follows the refined ability for expression that women have.
...
```
For a while there, boy names that became popular were at one point in the past popular. However, there seems to be a new trend among millenial parents with a name like Liam coming out of nowhere...
...
* Both male and female top names are holding a first-place rank for shorter durations than they have in the past.
* Name creativity really started accelerating in the 1970's.
