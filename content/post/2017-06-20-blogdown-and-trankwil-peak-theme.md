...
6. Deploy site. Netlify will generate a random URL `<netlify-name>.netlify.com`, like `destiny-jones-84018.netlify.com`.
...
Disqus is great for comments, but can be confusing to get set up. There are two parts - setting up a Disqus account and site and updating your config.

Set things up on Disqus:

1. Go to Disqus.com and create a profile.
...
You've got a great blog ready to go! If you want to change the background photo, do so by reading the `config.toml` page and updating where necessary with new links to your photos. 

There are things I'd like to add to my Trankquilpeak theme site, such as a project page. Perhaps if I get some time to read the Hugo docs I can figure out how to do that.
