...
library(htmlwidgets)
library(htmltools)
# dir.create("static/img/20180720/leaflet", showWarnings = FALSE)
# saveWidget(leafMap, "static/img/20180720/leaflet/leafMap.html")
# setwd(currentWD)
# saveWidget(leafMap, file="/img/leafMap.html")
```
Iframe:
<iframe src='/img/leafMap/index.html'></iframe>

<iframe src='/img/leafMap.html'></iframe>

# TODO: RENDER IMAGES AND LEAFLET PLOT
